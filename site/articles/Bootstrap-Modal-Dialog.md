---
title: A Blazor Bootstrap Modal Dialog
oneliner: A Botstrap Bootstrap Modal Dialog for Blazor.
precis: This article describes how to build a Bootstrap modal dialog for Blazor that you can use with any form.
date: 2020-10-23
...
For a web based SPA [Single Page Application] to look like a real application it needs a modal dialog framework.  This article shows how to build a modal dialog container for Blazor `IComponents` utilising the Bootstrap Modal Dialog CSS Framework.
