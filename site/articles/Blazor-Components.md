...
This article looks at the anatomy of a component, its life cycle and how Blazor uses and manages components in building and running the UI.

A deep understanding of components makes developing Blazor applications a very different experience. 
...
![Root Render Tree](/siteimages/articles/razor-component/Root-Render-tree.png)
...
![Server Rendering](/siteimages/articles/razor-component/Server-render.png)
...
![Server Rendering](/siteimages/articles/razor-component/Web-Assembly-render.png)
...
![Simple Page Loading](/siteimages/articles/razor-component/simple-page-loading.png)
...
![Simple Page Loaded](/siteimages/articles/razor-component/simple-page-loaded.png)
